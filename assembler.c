...
void ldw(FILE *outfile, char *Arg1, char *Arg2, char *Arg3, char *Arg4, int current_address)
{
  ...
  int output = code << 12 | (dest << 9) | (source1 << 6) | (offset & 0x3F);
  fprintf(outfile, "0x%.4X\n", output);
}
  ...
  */
  ...
  do
  {
    ...
    if (lRet != DONE && lRet != EMPTY_LINE)
    {
      ...
      {
      case 0:
        add(outfile, lArg1, lArg2, lArg3, lArg4);
        break; // 1/2 work
      case 1:
        and_(outfile, lArg1, lArg2, lArg3, lArg4);
        break;
      case 2:
      ...
      case 3:
        ...
        break;
      case 4:
        jsr(outfile, lArg1, current_address);
        break;
      case 5:
        jsrr(outfile, lArg1);
        break;
      case 6:
        ldb(outfile, lArg1, lArg2, lArg3, lArg4);
        break;
      case 7:
        ldw(outfile, lArg1, lArg2, lArg3, lArg4, current_address);
        break; // d works
      case 8:
        lea(outfile, lArg1, lArg2, lArg3, lArg4, current_address);
        break; // d works
      case 9:
        fprintf(outfile, "0x0000\n");
        break; // d works
      case 10:
        not_(outfile, lArg1, lArg2);
        break; // d works
      case 11:
        ret(outfile);
        break;
      case 12:
        lshf(outfile, lArg1, lArg2, lArg3, lArg4);
        break;
      case 13:
        rshfl(outfile, lArg1, lArg2, lArg3, lArg4);
        break;
      case 14:
        rshfa(outfile, lArg1, lArg2, lArg3, lArg4);
        break;
      case 15:
        rti(outfile);
        break;
      case 16:
        stb(outfile, lArg1, lArg2, lArg3, lArg4, current_address);
        break; // d works
      case 17:
        stw(outfile, lArg1, lArg2, lArg3, lArg4, current_address);
        break; // d works
      case 18:
        fprintf(outfile, "0x%.4X\n", (0xF000 | (toNum(lArg1) & 0xFF)));
        break; // d works
      case 19:
        xor_(outfile, lArg1, lArg2, lArg3);
        break; // d works
      case 20:
        br(outfile, 1, 1, 1, lArg1, current_address);
        break; // d works
      case 21:
        br(outfile, 1, 0, 0, lArg1, current_address);
        break; // d works
      case 22:
        br(outfile, 0, 1, 0, lArg1, current_address);
        break; // d works
      case 23:
        br(outfile, 0, 0, 1, lArg1, current_address);
        break; // d works
      case 24:
        br(outfile, 0, 1, 1, lArg1, current_address);
        break; // d works
      case 25:
        br(outfile, 1, 0, 1, lArg1, current_address);
        break; // d works
      case 26:
        br(outfile, 1, 1, 0, lArg1, current_address);
        break; // d works
      case 27:
        br(outfile, 1, 1, 1, lArg1, current_address);
        break; // d works
